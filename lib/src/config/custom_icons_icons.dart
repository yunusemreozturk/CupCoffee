...
class CustomIcons {
  ...
  static const IconData map_pin = IconData(0xe801, fontFamily: _kFontFam, fontPackage: _kFontPkg);
  static const IconData shopping_bag = IconData(0xe802, fontFamily: _kFontFam, fontPackage: _kFontPkg);
